...
import { Landmark, Compass, Users, CheckCircle2, MessageCircle, MapPin, Calendar } from 'lucide-react';
...
export default function CulturalTemplate({ data }: TemplateProps) {
  ...
  const encodedMsg = encodeURIComponent(`Hola ${data.guideName || 'Guía Cultural'}, me interesa reservar el tour cultural "${data.name}". ¿Qué fechas tienen disponibles?`);
    ...
    <div className="min-h-screen bg-stone-100 font-sans text-stone-800 selection:bg-amber-700 selection:text-white">
      ...
      <section id="contacto" className="py-20 px-8 text-center bg-stone-900 text-white">
        <div className="max-w-xl mx-auto space-y-6">
          <h2 className="text-3xl font-serif font-bold">¿Tienes dudas o deseas reservar tus fechas?</h2>
